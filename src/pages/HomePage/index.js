...
const HomePage = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // 4. Buscar TODOS os produtos em destaque que estão disponíveis
      ...
      // Todos os produtos marcados como destaque serão exibidos
    ...
    <HomePageWrapper>
      ...
      {featuredProducts.length > 0 && (
        <Section>
          ...
          <ContentGrid>
            {/* Verifica se um produto em destaque também está em promoção para passar os preços corretos */}
